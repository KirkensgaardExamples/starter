...
./gradlew build
```
It produces the `starter-1.0.0-SNAPSHOT-runner.jar` file in the `/build` directory.
...
The application is now runnable using `java -jar build/starter-1.0.0-SNAPSHOT-runner.jar`.
...
You can then execute your native executable with: `./build/starter-1.0.0-SNAPSHOT-runner`
